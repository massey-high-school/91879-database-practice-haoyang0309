...
--
-- Host: localhost
-- Generation Time: Sep 13, 2020 at 05:04 PM
...
--
-- Table structure for table `L1_prac_book_reviews`
--

CREATE TABLE IF NOT EXISTS `L1_prac_book_reviews` (
...
--
-- Dumping data for table `L1_prac_book_reviews`
--

INSERT INTO `L1_prac_book_reviews` (`ID`, `Title`, `Author`, `Genre`, `Rating`, `Review`) VALUES
